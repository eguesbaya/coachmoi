 ...
 */
final class Version20210707085720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coach_booking (id INT AUTO_INCREMENT NOT NULL, coach_id INT DEFAULT NULL, client_id INT NOT NULL, training_space_id INT DEFAULT NULL, INDEX IDX_5BDC05963C105691 (coach_id), UNIQUE INDEX UNIQ_5BDC059619EB6921 (client_id), INDEX IDX_5BDC0596C43240D7 (training_space_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
