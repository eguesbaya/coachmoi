 ...
 */
final class Version20210708190341 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, practice_level_id INT DEFAULT NULL, activity_id INT NOT NULL, goal LONGTEXT DEFAULT NULL, budget INT DEFAULT NULL, group_size INT DEFAULT NULL, is_apt TINYINT(1) DEFAULT NULL, birthdate DATE DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, created_at DATE DEFAULT NULL, UNIQUE INDEX UNIQ_C7440455A76ED395 (user_id), INDEX IDX_C744045558D2F8A2 (practice_level_id), INDEX IDX_C744045581C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE coach (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, birthdate DATE NOT NULL, has_vehicle TINYINT(1) NOT NULL, qualification LONGTEXT NOT NULL, equipment LONGTEXT DEFAULT NULL, biography LONGTEXT NOT NULL, hourly_rate INT NOT NULL, photo VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_3F596DCCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE coach_booking (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, training_space_id INT DEFAULT NULL, coach_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_5BDC059619EB6921 (client_id), INDEX IDX_5BDC0596C43240D7 (training_space_id), INDEX IDX_5BDC05963C105691 (coach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
